...
function initCompetitive() {
  ...
  // Social follower counts and product lists researched from each business's public
  // Facebook/Instagram pages and websites, Sep 2026 -- snapshot figures, will drift.
  // ig:null where a public follower count couldn't be confirmed.
  const RETAILERS = [
    { id:"moomers", name:"Moomers Homemade Ice Cream", color:"#d7191c", primary:true,
      fb:34443, ig:13000,
      products:["Ice Cream", "Sorbet & Vegan", "Ice Cream Cakes", "Pies", "Novelties"],
    ...
    { id:"mooville", name:"Moo-Ville Creamery", color:"#fdae61", primary:true,
      fb:49723, ig:3560,
      products:["Milk", "Ice Cream", "Cheese Curds", "Butter", "Buttermilk", "Ground Beef"],
      locations:[
    ...
    { id:"calder", name:"Calder Dairy & Farm", color:"#2ca25f", primary:false,
      fb:25984, ig:null,
      products:["Milk", "Butter", "Buttermilk", "Cottage Cheese", "Cream", "Eggnog", "Yogurt", "Sour Cream & Dip", "Ice Cream", "Fudge"],
      locations:[
  ...
  document.getElementById("compKeyTable").innerHTML =
    `<thead><tr><th></th><th>Retailer</th><th class="n">Locations</th><th class="n">Avg. distance</th><th class="n">Facebook</th><th class="n">Instagram</th></tr></thead>
    <tbody>${RETAILERS.map(r => `
      <tr class="${r.primary ? "" : "comp-other"}">
        ...
        <td class="n">${fmtSocial(r.fb)}</td>
        <td class="n">${fmtSocial(r.ig)}</td>
      </tr>`).join("")}
    </tbody>`;
...
const SWOT_THEMES = {
  strengths: [
    ...
    { name: "People & Culture", color: "#1a6b35",
      strong: ["Team and Owner Commitment to Strive for Success", "People", "Leadership", "Strong Values That Guide Us", "Future Focusing"] },
